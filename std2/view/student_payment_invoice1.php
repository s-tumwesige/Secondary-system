...
?>                                    
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-1">Amount(Ugx)</th>
                             ...
                             <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        <span id="spanaFee"><?php echo $admission_fee; ?>Ugx</span> 
                                        <span id="spanmFee"><?php echo $monthly_fee; ?>Ugx</span> <br>
										<span id="spanTotal"><?php echo $total; ?>Ugx</span> <br>
                                        <span id="spanPaid"><?php echo $total; ?>Ugx</span> <br>
                                      </strong>
  								</div>
