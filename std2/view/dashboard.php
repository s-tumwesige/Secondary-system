...
<div class="content-wrapper">
    ...
    <section class="content-header">
    	<h1>Dashboard<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
...
?>             
              ...
              <span class="info-box-number"><small>UgShs: </small><?php echo $monthly_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
?>             
              ...
              <span class="info-box-number"><small>UgShs: </small><?php echo $total_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
